...
class SofasDetailsScreen extends StatefulWidget {
  
  @override
  _SofasDetailsScreenState createState() => _SofasDetailsScreenState();
}

class _SofasDetailsScreenState extends State<SofasDetailsScreen> {
  int quantity = 0;
        ...
        slivers: [
          SliverAppBar(
            ...
            flexibleSpace: FlexibleSpaceBar(
              background: Image.asset("assets/images/sofas.jpg", width: 300, fit: BoxFit.cover,),
            ),
            elevation: 0,
