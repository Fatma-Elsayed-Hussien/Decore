...
class NightDetailsScreen extends StatefulWidget {
  
  @override
  _NightDetailsScreenState createState() => _NightDetailsScreenState();
}

class _NightDetailsScreenState extends State<NightDetailsScreen> {
  int quantity = 0;
        ...
        slivers: [
          SliverAppBar(
            ...
            flexibleSpace: FlexibleSpaceBar(
              background: Image.asset("assets/images/night-stand.jpg", width: 300, fit: BoxFit.cover,),
            ),
            elevation: 0,
