...
class DesksDetailsScreen extends StatefulWidget {
  
  @override
  _DesksDetailsScreenState createState() => _DesksDetailsScreenState();
}

class _DesksDetailsScreenState extends State<DesksDetailsScreen> {
  int quantity = 0;
        ...
        slivers: [
          SliverAppBar(
            ...
            flexibleSpace: FlexibleSpaceBar(
              background: Image.asset("assets/images/desk.jpg", width: 300, fit: BoxFit.cover,),
            ),
            elevation: 0,
